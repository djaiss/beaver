...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('loans', function (Blueprint $table): void {
            ...
            $table->unsignedBigInteger('condition_out_id')->nullable()->comment('the copy condition when it left, null when unrecorded');
            $table->unsignedBigInteger('condition_in_id')->nullable()->comment('the copy condition when it came back, null until returned or unrecorded');
