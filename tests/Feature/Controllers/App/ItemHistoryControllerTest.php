...
it('shows the valuations section when it is selected', function () {
    ...
    $this->actingAs($user)->get(route('items.history.section', [$collection, $item, $copy, 'valuations']))
        ->assertOk()
...
it('shows a placeholder for a section that is not built yet', function () {
    ...
    $this->actingAs($user)->get(route('items.history.section', [$collection, $item, $copy, 'insurance']))
        ->assertOk()
...
it('falls back to the timeline for an unknown section', function () {
    ...
    $this->actingAs($user)->get(route('items.history.section', [$collection, $item, $copy, 'nonsense']))
        ->assertOk()
...
it('lists the transactions of a copy, newest first', function () {
    ...
    $this->actingAs($user)->get(route('items.history.section', [$collection, $item, $copy, 'transactions']))
        ->assertOk()
...
it('does not offer a viewer any way to change a transaction', function () {
    ...
    $this->actingAs($viewer)->get(route('items.history.section', [$collection, $item, $copy, 'transactions']))
        ->assertOk()
...
it('lists the provenance of a copy on a timeline, oldest first', function () {
    ...
    $this->actingAs($user)->get(route('items.history.section', [$collection, $item, $copy, 'provenance']))
        ->assertOk()
...
it('does not offer a viewer any way to change a provenance event', function () {
    ...
    $this->actingAs($viewer)->get(route('items.history.section', [$collection, $item, $copy, 'provenance']))
        ->assertOk()
