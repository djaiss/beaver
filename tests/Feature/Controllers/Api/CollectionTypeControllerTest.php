...
it('lists the collection types of the account, most recently updated first', function () {
    ...
    $older = CollectionType::factory()->create([
        'account_id' => $user->account_id,
        'name' => 'Comics',
        'updated_at' => '2025-01-01 10:00:00',
    ]);
    $newer = CollectionType::factory()->create([
        'account_id' => $user->account_id,
        'name' => 'Wine',
...
it('shows a collection type', function () {
    ...
    $response
        ...
        ->assertJsonPath('data.links.self', route('api.collectionTypes.show', $type->id));
});
