...
You need the address of your KolleK instance. If you self host, that is the URL you set up during installation. If someone hosts KolleK for you, they will give you the link.

## Sign up

Open your instance and go to the registration page. Fill in:
...
## A few guardrails to expect

KolleK checks a few things when you register, so you are not caught out:

- **Disposable email addresses are rejected.** Use an address you will keep, since account recovery and notifications depend on it.
- **Your password must be at least eight characters.**
- **Weak or breached passwords are refused.** KolleK checks your password against lists of passwords known to have leaked in past breaches. If yours has appeared in one, you will be asked to choose another. This is about the password itself, not your account, so pick something you have not used elsewhere.

## What you get

Creating an account sets up two things:
