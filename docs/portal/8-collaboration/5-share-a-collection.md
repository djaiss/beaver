...
Select **Private**, **Shared**, or **Public**.

::screenshot{label="Collection form with the three visibility choices"}
:::

:::step title="Save"
Save the collection. The setting is stored immediately.
:::
::::

Emma marks her "Wishlist Research" collection private, "My Comics" shared for Sam and Leo, and "Vintage Posters" public, ready for the day she can send a link around.

## Why set it now

Setting visibility today means your catalogue already behaves correctly the moment sharing is switched on. A collection you marked private will become private, and one you marked public will get its link, without you having to revisit every collection then.

:::warning
When public links arrive, a public collection will be viewable by anyone who has the link, without signing in, including every item, photo, and detail in it. Do not mark a collection public if you would not be comfortable with that, especially if it reveals what you own and where you live.
:::
