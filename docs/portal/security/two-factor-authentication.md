...
If you cannot reach your app, enter one of your [recovery codes](recovery-codes.md) instead.

:::note
Signing in with a [magic link](magic-links.md) does not ask for a two factor code. Access to your email inbox already acts as the second factor, so protect that inbox accordingly.
:::
...
- Make sure your fallback works: [Save and use your recovery codes](recovery-codes.md).
- Understand the passwordless path and its trade off: [Magic links explained](magic-links.md).
- See every way to get into the app: [Signing in](../getting-started/signing-in.md).
