...
:::note
If you would rather skip the reset entirely, a [magic link](magic-links.md) can sign you in without a password. Once you are in, you can set a new password from your profile.
:::
...
- Add a second step so a stolen password is not enough: [Protect your account with two factor authentication](two-factor-authentication.md).
- Still cannot get in? Work through [Troubleshooting sign in](../troubleshooting/troubleshoot-sign-in.md).
- Reset email never arrived? See [Troubleshooting email delivery](../troubleshooting/troubleshoot-email-delivery.md).
