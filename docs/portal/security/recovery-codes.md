...
Recovery codes are your way back in if you lose your authenticator. When you turn on [two factor authentication](two-factor-authentication.md), KolleK generates eight of them. Each code works exactly once, in place of a code from your app.
...
- Set up or reset the code step itself: [Protect your account with two factor authentication](two-factor-authentication.md).
- Locked out in some other way? See [Troubleshooting sign in](../troubleshooting/troubleshoot-sign-in.md).
