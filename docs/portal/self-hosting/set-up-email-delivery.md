...
Email is how KolleK reaches people outside a browser session: [invitations](../collaboration/invite-people.md), [magic links](../security/magic-links.md), password resets, email verification, and [security alerts](../security/security-alert-emails.md) all arrive by email. Until you configure delivery, none of them go anywhere.
...
:::note
If someone says "I never got the invitation" on a new instance, this default is almost always why. The email exists, in the log file. See [Troubleshooting email delivery](../troubleshooting/troubleshoot-email-delivery.md).
:::
...
- The recipient's **sent emails** page in their profile, which lists what the instance sent them. See [Your personal activity log and sent emails](../account-and-profile/activity-log-and-sent-emails.md).
...
- Recognize the emails your instance sends in [Emails KolleK sends](../reference/emails-kollek-sends.md).
- Diagnose delivery problems in [Troubleshooting email delivery](../troubleshooting/troubleshoot-email-delivery.md).
