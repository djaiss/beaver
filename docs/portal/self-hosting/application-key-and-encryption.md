...
This is what [How your data is protected](../core-concepts/how-your-data-is-protected.md) describes from the user's point of view. Operationally it means the key is not a configuration detail. It is half of your data.
...
- Make sure the key is part of your [backup and restore plan](back-up-and-restore.md).
- Read the user facing view of encryption in [How your data is protected](../core-concepts/how-your-data-is-protected.md).
