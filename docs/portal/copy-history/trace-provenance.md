...
This is the same rule you met in [Record what you paid and what it is worth](record-payments-and-value.md), applied from the other side.
...
Some provenance builds itself. A [loan](lend-and-borrow-copies.md) marked as part of provenance adds matching loan and return events, and a [maintenance record](record-maintenance-and-repairs.md) flagged as significant appears as a restoration event. You assemble the deep past; the present documents itself as it happens.

## Where to next

- Attach the archive extract or certificate to its event in [Attach documents to a copy](attach-documents.md).
- Record the purchase the acquisition event links to in [Record what you paid and what it is worth](record-payments-and-value.md).
- Read the finished story in [Read the copy timeline](read-the-copy-timeline.md).
