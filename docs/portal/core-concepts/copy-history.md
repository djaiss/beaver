...
Look at one of Priya's watches. The copy tells you its current state at a glance: its [condition](conditions.md) is Used, its current [location](locations.md) is the display case, its estimated value is what the last appraisal said.
...
- **Transactions** record money and ownership changes: what you paid, what you sold for, fees, shipping. See [Record what you paid and what it is worth](../copy-history/record-payments-and-value.md).
...
- **Insurance records** capture coverage: provider, insured value, policy dates. See [Insure a copy](../copy-history/insure-a-copy.md).
- **Loans** track custody when a copy leaves your hands or arrives from someone else. See [Lend and borrow copies](../copy-history/lend-and-borrow-copies.md).
- **Maintenance records** log cleaning, repair, and conservation work. See [Record maintenance and repairs](../copy-history/record-maintenance-and-repairs.md).
- **Provenance events** build the ownership and authenticity story. See [Trace a copy's provenance](../copy-history/trace-provenance.md).
- **Location history** remembers every place the copy has lived. See [Move a copy](../copy-history/move-a-copy.md).

You can also [attach documents](../copy-history/attach-documents.md) (receipts, appraisals, certificates) to the copy or to any individual record, and read everything merged together on [the copy timeline](../copy-history/read-the-copy-timeline.md).
...
- Start with the money in [Record what you paid and what it is worth](../copy-history/record-payments-and-value.md).
- See the whole story in one view in [Read the copy timeline](../copy-history/read-the-copy-timeline.md).
- Follow one prized piece end to end in the tutorial [Track the full life of a valuable item](../tutorials/track-a-valuable-item.md).
