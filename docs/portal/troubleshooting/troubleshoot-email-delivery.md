...
**If you operate the instance**, set up SMTP or Resend by following [Set up email delivery](../self-hosting/set-up-email-delivery.md).
...
Full details on this screen in [Your personal activity log and sent emails](../account-and-profile/activity-log-and-sent-emails.md).
...
Transactional email from a small self hosted instance is exactly what spam filters are suspicious of. Marking one message as "not spam" usually teaches your provider. Operators can improve deliverability with proper sender configuration, covered in [Set up email delivery](../self-hosting/set-up-email-delivery.md).

## Where to next

- Operator setup for real delivery: [Set up email delivery](../self-hosting/set-up-email-delivery.md).
- Your personal email history: [Your personal activity log and sent emails](../account-and-profile/activity-log-and-sent-emails.md).
- What each email is and when it fires: [Emails KolleK sends](../reference/emails-kollek-sends.md).
