...
title: Group a franchise with series
...
## Create a series and link items

::::steps
:::step title="Create the series"
Open **Series** and choose **New series**. Give it a name, such as "Star Wars".

::screenshot{label="New series form"}
:::

:::step title="Link items from the item form"
When adding or editing an item, pick the series on the item form. Items from any collection can join the same series.
:::

:::step title="View the series"
Open the series page. Its items appear grouped by the collection they live in, with a count of how many items are linked and how many collections the series reaches.

::screenshot{label="Series page with items grouped by collection"}
:::
::::
...
Deleting a series removes the umbrella only. The items that were part of it keep all their data and stay exactly where they are.
