...
Faster alternative: request a [magic link](../10-security/4-magic-links.md) instead. It signs you in without a password, and you can set a new password afterwards from your profile.

Full details in [Reset your password](../10-security/5-reset-your-password.md).

## My new password keeps being refused

KolleK requires at least eight characters and refuses any password that has appeared in a public data breach. The refusal is about the password itself, not your account. Pick something longer and unique that you have not used elsewhere. See [Reset your password](../10-security/5-reset-your-password.md).
...
Full details in [Save and use your recovery codes](../10-security/3-recovery-codes.md).
...
Full details in [Magic links explained](../10-security/4-magic-links.md).

## I tried too many times and now I am blocked

Repeated rapid attempts are throttled to slow down password guessing. Wait a minute and try again, carefully. If you are unsure of the password, switch to the [reset flow](../10-security/5-reset-your-password.md) or a [magic link](../10-security/4-magic-links.md) rather than guessing on.

## I got a "failed sign in" email I do not recognize

Someone entered your email with a wrong password. See [Login and security alert emails](../10-security/6-security-alert-emails.md) for what it means and when to act.
...
Full details in [Invite people to your account](../8-collaboration/2-invite-people.md).

## The email I am waiting for never arrives

The reset email, the magic link, or the invitation may not be reaching you. That is usually a delivery problem rather than a sign in problem. See [Troubleshooting email delivery](3-troubleshoot-email-delivery.md).

## Where to next

- The basics of every sign in path: [Signing in](../2-getting-started/5-signing-in.md).
- Harden things once you are back in: [Security overview](../10-security/1-introduction.md).
