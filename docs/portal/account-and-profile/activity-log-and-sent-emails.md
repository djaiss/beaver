...
The [activity trail](../core-features/activity-feed-and-audit-trail.md) that runs through the whole account has a personal view: a full history of your own actions, from creating an item to changing a setting. Open it from your profile area.

Use it to retrace your steps. If a copy's location looks wrong, your log will show whether you moved it, and when.

## Your sent emails

KolleK records every email it sends you: magic links, invitations you received, verification messages, and [security alerts](../security/security-alert-emails.md). Your profile area lists them, most recent first, ten per page.
...
- **Emails appear here but none are ever delivered.** On a self hosted instance this usually means mail delivery is not configured yet. Point your operator at [set up email delivery](../self-hosting/set-up-email-delivery.md).
...
- Understand the account wide history in [The activity feed and audit trail](../core-features/activity-feed-and-audit-trail.md).
- Missing an expected email? Work through [Troubleshooting email delivery](../troubleshooting/troubleshoot-email-delivery.md).
