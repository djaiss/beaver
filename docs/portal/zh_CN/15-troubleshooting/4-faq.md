...
自托管是免费的，而且没有藏品数量限制。在托管实例上，一个账户可免费容纳十件藏品，之后通过一次性付款解锁，绝不是订阅。两种方式都没有套餐、没有分级，也没有需要付费才能解锁的功能：无论你以哪种方式运行，所有功能都已经包含在内。参见 @doc(account.freePlan) 和 @doc(kollek.hostingOptions)。
