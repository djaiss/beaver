...
A type does nothing until a [collection](../core-concepts/collections.md) enables it. When you create or edit a collection, choose which types apply. A collection can enable several, and the same type can serve many collections. Once enabled, items in that collection can pick the type and fill in its fields.

## Where to next

- Share a setup you are proud of, or borrow one, with [Import and export a collection type](import-and-export-a-collection-type.md).
- Put the fields to work in [Add and edit items](../core-features/add-and-edit-items.md).
- Round out your setup with [Set up your locations](set-up-your-locations.md).
