...
return [
    ...
    'adminland' => [
        ...
        'relationship_types' => [
            ...
            'forward_name' => 'Nom dans le sens direct',
            'is_directed' => 'Cette relation dépend du sens',
            'is_directed_help' => 'Activez cette option si la relation signifie quelque chose de différent selon le sens (par exemple, parent → enfant). Laissez-la désactivée pour les relations qui ont le même sens dans les deux directions, comme ami ou frère et sœur.',
            'new_category' => 'Nouvelle catégorie',
            'new_type' => 'Nouveau type de relation',
            'none' => 'Aucune catégorie de types de relation créée',
            'reverse_name' => 'Nom dans le sens inverse',
