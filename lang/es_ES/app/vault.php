...
return [
    ...
    'adminland' => [
        ...
        'relationship_types' => [
            ...
            'forward_name' => 'Nombre en sentido directo',
            'is_directed' => 'Esta relación es direccional',
            'is_directed_help' => 'Activa esta opción si la relación significa algo diferente según la dirección (por ejemplo, progenitor → hijo). Déjala desactivada para las relaciones que significan lo mismo en ambos sentidos, como amistad o hermandad.',
            'new_category' => 'Nueva categoría',
            'new_type' => 'Nuevo tipo de relación',
            'none' => 'No se han creado categorías de tipos de relación',
            'reverse_name' => 'Nombre en sentido inverso',
