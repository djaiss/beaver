...
return [
    ...
    'adminland' => [
        ...
        'relationship_types' => [
            ...
            'forward_name' => 'Name in Vorwärtsrichtung',
            'is_directed' => 'Diese Beziehung ist richtungsabhängig',
            'is_directed_help' => 'Aktivieren Sie diese Option, wenn die Beziehung je nach Richtung etwas anderes bedeutet (zum Beispiel Elternteil → Kind). Lassen Sie sie deaktiviert, wenn die Beziehung in beide Richtungen dasselbe bedeutet, wie etwa Freund oder Geschwisterteil.',
            'new_category' => 'Neue Kategorie',
            'new_type' => 'Neuer Beziehungstyp',
            'none' => 'Keine Beziehungstyp-Kategorien erstellt',
            'reverse_name' => 'Name in Rückwärtsrichtung',
