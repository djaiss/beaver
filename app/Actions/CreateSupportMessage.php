...
/**
 * Add a reply to a support conversation. Replying to a closed conversation
 * reopens it, so a user does not have to start over to follow up.
 */
class CreateSupportMessage
{
    ...
    {
        if ($this->ticket->status === SupportTicketStatus::Closed) {
