...
class CatalogStatistics
{
    ...
    {
        $items = $this->catalog->items()->count();
        ...
        return [
            ...
            'itemsAddedThisMonth' => $this->catalog->items()->where('created_at', '>=', $startOfMonth)->count(),
    ...
    public function byCategory(): array
    {
        ...
        $uncategorised = $this->catalog->items()->whereNull('category_id')->count();
    ...
    private function valued(): QueryBuilder
    {
        ...
        return DB::table('copies')
            ...
            ->where('items.catalog_id', $this->catalog->id)
