...
Route::middleware(['auth', 'verified', 'throttle:60,1', 'set.locale'])->group(function (): void {
    ...
    Route::get('collections/{collection}/items/{item}/history/{copy}/{section}', [ItemHistoryController::class, 'show'])->where(['collection' => '[1-9][0-9]*', 'item' => '[1-9][0-9]*', 'copy' => '[1-9][0-9]*', 'section' => '[a-z]+'])->name('items.history.section');
