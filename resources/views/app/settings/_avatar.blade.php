      ...
      <div class="flex items-center gap-4">
        ...
        <div class="space-y-3">
          <x-form method="post" :action="route('profile.avatar.update')" :upload="true" class="space-y-3">
            <input type="file" id="avatar" name="avatar" accept="image/jpeg,image/png,image/webp" required class="block w-full cursor-pointer text-sm text-muted file:mr-3 file:cursor-pointer file:rounded-md file:border file:border-hairline file:bg-canvas file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-ink" />
