<x-box padding="p-0">
  ...
  <div id="gender-list" class="divide-y divide-gray-200 dark:divide-gray-700">
    @forelse ($genders as $gender)
      <div id="gender-{{ $gender['id'] }}" class="group flex items-center justify-between p-3 transition-colors duration-200 hover:bg-blue-50 dark:hover:bg-gray-800">
