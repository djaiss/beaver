<div class="sticky top-16 z-40 border-b border-gray-200 bg-white">
  <div class="flex h-14 items-center gap-6 px-4 sm:px-8">
    <a href="{{ route('marketing.docs.api.index') }}" class="flex shrink-0 items-center gap-2 text-sm font-semibold text-gray-900">
      <x-lucide-code class="h-4 w-4 text-gray-500" />
      API
      <span class="rounded-full bg-gray-100 px-2 py-0.5 font-mono text-[11px] font-semibold text-gray-700">v1</span>
    </a>
