...
@php
  ...
  $visual = 'border border-transparent bg-canvas text-body hover:border-hairline hover:bg-card hover:shadow-xs focus-visible:ring-primary/20 active:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.1)]';
  $classes = $base . ' ' . $visual;
@endphp
